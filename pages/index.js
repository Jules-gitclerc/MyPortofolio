                ...
                <section>
                    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto space-y-10 ">
                        ...
                        <div className="grid md:grid-cols-2 gap-12">
                            <div className="flex flex-col h-full justify-center lg:w-3/4">
                                <h2 className="text-3xl text-gray-800 font-bold lg:text-3xl dark:text-white">
                                    {t('work.section_1.title')}
                                </h2>
                                <p className="mt-3 text-gray-800 dark:text-gray-400">
                                    {t('work.section_1.description')}
                                </p>
                                <p className="mt-5 inline-flex items-center gap-x-10 font-medium text-blue-600 dark:text-blue-500">
                            ...
                            <div className="space-y-6 lg:space-y-10">
                                <div className="flex">
                                    <span
                                        ...
                                        <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="16"
                                    ...
                                    <div className="ml-5 sm:ml-8">
                                        <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-200">
                                            {t('work.section_1.details.point_1.title')}
                                        </h3>
                                        <p className="mt-1 text-gray-600 dark:text-gray-400">
                                            {t('work.section_1.details.point_1.description')}
                                        </p>
                                    </div>
                                </div>
                                <div className="flex">
                                    ...
                                    <div className="ml-5 sm:ml-8">
                                        <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-200">
                                            {t('work.section_1.details.point_2.title')}
                                        </h3>
                                        <p className="mt-1 text-gray-600 dark:text-gray-400">
                                            {t('work.section_1.details.point_2.description')}
                                        </p>
                                    </div>
                                </div>
                                <div className="flex">
                                    ...
                                    <div className="ml-5 sm:ml-8">
                                        <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-200">
                                            {t('work.section_1.details.point_3.title')}
                                        </h3>
                                        <p className="mt-1 text-gray-600 dark:text-gray-400">
                                            {t('work.section_1.details.point_3.description')}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-12">
                            <div className="flex flex-col h-full justify-center lg:w-3/4">
                                <h2 className="text-3xl text-gray-800 font-bold lg:text-3xl dark:text-white">
                                    {t('work.section_2.title')}
                                </h2>
                                <p className="mt-3 text-gray-800 dark:text-gray-400">
                                    {t('work.section_2.description')}
                                </p>
                                <p className="mt-5 inline-flex items-center gap-x-10 font-medium text-blue-600 dark:text-blue-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24"
                                         viewBox="0 0 48 48">
                            ...
                            <div className="space-y-6 lg:space-y-10">
                                <div className="flex">
                                    ...
                                    <div className="ml-5 sm:ml-8">
                                        <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-200">
                                            {t('work.section_2.details.point_1.title')}
                                        </h3>
                                        <p className="mt-1 text-gray-600 dark:text-gray-400">
                                            {t('work.section_2.details.point_1.description')}
                                        </p>
                                    </div>
                                </div>
                                <div className="flex">
                                    ...
                                    <div className="ml-5 sm:ml-8">
                                        <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-200">
                                            {t('work.section_2.details.point_2.title')}
                                        </h3>
                                        <p className="mt-1 text-gray-600 dark:text-gray-400">
                                            {t('work.section_2.details.point_2.description')}
                                        </p>
                                    </div>
                                </div>
                                <div className="flex">
                                    ...
                                    <div className="ml-5 sm:ml-8">
                                        <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-200">
                                            {t('work.section_2.details.point_3.title')}
                                        </h3>
                                        <p className="mt-1 text-gray-600 dark:text-gray-400">
                                            {t('work.section_2.details.point_3.description')}
                                        </p>
                                    </div>
                                </div>
                            </div>
