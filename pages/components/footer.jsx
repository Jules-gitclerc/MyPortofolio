        ...
        <footer className="bg-gray-100 dark:bg-gray-800">
            <div className="text-center mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
                <div className="mt-3">
                    ...
                    <p className="text-gray-500">© 2024 Jules Clerc. All rights reserved.</p>
                </div>

                <div className="mt-3 space-x-2">
                    <SocialButton url="https://linkedin.com/in/jules-clerc" label="LinkedIn">
                        <svg
                    ...
                    <SocialButton url="https://github.com/Jules-gitclerc" label="GitHub">
                        <svg
                            className="w-3.5 h-3.5"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
